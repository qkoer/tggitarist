...
from tgbot.modules.sql.locales_sql import switch_to_locale, prev_locale
from tgbot.modules.tr_engine.strings import tld, LANGUAGES
from telegram.ext import CommandHandler
from telegram import ParseMode, InlineKeyboardMarkup, InlineKeyboardButton
from tgbot import dispatcher
from tgbot.modules.tr_engine.list_locale import list_locales
...
def locale_button(bot, update):
    ...
    lang_match = re.findall(r"en-US|en-GB|id|ru|tr", query.data)
    if lang_match:
        if lang_match[0]:
